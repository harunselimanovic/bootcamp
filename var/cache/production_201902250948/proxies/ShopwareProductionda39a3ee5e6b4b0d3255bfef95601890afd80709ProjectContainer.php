...
class ShopwareProductionda39a3ee5e6b4b0d3255bfef95601890afd80709ProjectContainer extends \Shopware\Components\DependencyInjection\Container
{
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/Applications/MAMP/htdocs/bootcamp/var/log/core_production.log', 14, 400);
    ...
    {
        $this->services['monolog.handler.rotating_file.es'] = $instance = new \Monolog\Handler\RotatingFileHandler('/Applications/MAMP/htdocs/bootcamp/var/log/es_production.log', 14, 400);
    ...
    protected function getPluginloggerService()
    {
        ...
        $a = new \Monolog\Handler\RotatingFileHandler('/Applications/MAMP/htdocs/bootcamp/var/log/plugin_production.log', 14, 400);
        $a->pushProcessor(${($_ = isset($this->services['monolog.processor.uid']) ? $this->services['monolog.processor.uid'] : $this->get('monolog.processor.uid')) && false ?: '_'});
    ...
    protected function getShopware_Emotion_PresetDataSynchronizerService()
    {
        ...
        }, 4), '/Applications/MAMP/htdocs/bootcamp/');
    }
    ...
    {
        return $this->services['shopware.esd.public.url_generator'] = new \Shopware\Components\Filesystem\PublicUrlGenerator($this, '/Applications/MAMP/htdocs/bootcamp', '/Applications/MAMP/htdocs/bootcamp/files');
    }
    ...
    {
        return $this->services['shopware.filesystem.public.url_generator'] = new \Shopware\Components\Filesystem\PublicUrlGenerator($this, '/Applications/MAMP/htdocs/bootcamp/', '/Applications/MAMP/htdocs/bootcamp/web', '');
    }
    ...
    {
        return $this->services['shopware.openssl_verificator'] = new \Shopware\Components\OpenSSLVerifier('/Applications/MAMP/htdocs/bootcamp/engine/Shopware/Components/HttpClient/public.key');
    }
    ...
    {
        return $this->services['shopware.release'] = new \Shopware\Components\ShopwareReleaseStruct('5.5.7', '', '201902250948');
    }
    protected function getShopware_RequirementsService()
    {
        return $this->services['shopware.requirements'] = new \Shopware\Components\Check\Requirements('/Applications/MAMP/htdocs/bootcamp/engine/Shopware/Components/Check/Data/System.xml', ${($_ = isset($this->services['db_connection']) ? $this->services['db_connection'] : $this->get('db_connection')) && false ?: '_'});
    }
    ...
    {
        return $this->services['shopware.snippet_database_handler'] = new \Shopware\Components\Snippet\DatabaseHandler(${($_ = isset($this->services['models']) ? $this->services['models'] : $this->get('models')) && false ?: '_'}, ${($_ = isset($this->services['db']) ? $this->services['db'] : $this->get('db')) && false ?: '_'}, '/Applications/MAMP/htdocs/bootcamp');
    }
    protected function getShopware_SnippetQueryHandlerService()
    {
        return $this->services['shopware.snippet_query_handler'] = new \Shopware\Components\Snippet\QueryHandler('/Applications/MAMP/htdocs/bootcamp/snippets/');
    }
    ...
    {
        return $this->services['theme_path_resolver'] = new \Shopware\Components\Theme\PathResolver('/Applications/MAMP/htdocs/bootcamp/', $this->parameters['shopware.plugin_directories'], '/Applications/MAMP/htdocs/bootcamp/themes/', '/Applications/MAMP/htdocs/bootcamp/web/cache/', ${($_ = isset($this->services['shopware.release']) ? $this->services['shopware.release'] : $this->get('shopware.release')) && false ?: '_'});
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Applications/MAMP/htdocs/bootcamp',
            'kernel.environment' => 'production',
            'kernel.debug' => false,
            'kernel.name' => 'Shopware',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948',
            'kernel.logs_dir' => '/Applications/MAMP/htdocs/bootcamp/var/log',
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'ShopwareProductionda39a3ee5e6b4b0d3255bfef95601890afd80709ProjectContainer',
            'shopware.release.version' => '5.5.7',
            'shopware.release.version_text' => '',
            'shopware.release.revision' => '201902250948',
            ...
            'shopware.filesystem' => array(
                'private' => array(
                    'type' => 'local',
                    'config' => array(
                        'root' => '/Applications/MAMP/htdocs/bootcamp/files',
                    ),
                ),
                'public' => array(
                    'type' => 'local',
                    'config' => array(
                        'root' => '/Applications/MAMP/htdocs/bootcamp/web',
                        'url' => '',
                    ),
                ),
            ),
            ...
            'shopware.filesystem.private.config.root' => '/Applications/MAMP/htdocs/bootcamp/files',
            ...
            'shopware.filesystem.public.config.root' => '/Applications/MAMP/htdocs/bootcamp/web',
            ...
            'shopware.cdn' => array(
                ...
                'adapters' => array(
                    'local' => array(
                        ...
                        'root' => '/Applications/MAMP/htdocs/bootcamp',
                    ),
                    'ftp' => array(
                        'type' => 'ftp',
                        'mediaUrl' => '',
            ...
            'shopware.cdn.adapters.local.root' => '/Applications/MAMP/htdocs/bootcamp',
            ...
            'shopware.plugin_directories' => array(
                'Default' => '/Applications/MAMP/htdocs/bootcamp/engine/Shopware/Plugins/Default/',
                'Local' => '/Applications/MAMP/htdocs/bootcamp/engine/Shopware/Plugins/Local/',
                'Community' => '/Applications/MAMP/htdocs/bootcamp/engine/Shopware/Plugins/Community/',
                'ShopwarePlugins' => '/Applications/MAMP/htdocs/bootcamp/custom/plugins/',
                'ProjectPlugins' => '/Applications/MAMP/htdocs/bootcamp/custom/project/',
            ),
            'shopware.plugin_directories.Default' => '/Applications/MAMP/htdocs/bootcamp/engine/Shopware/Plugins/Default/',
            'shopware.plugin_directories.Local' => '/Applications/MAMP/htdocs/bootcamp/engine/Shopware/Plugins/Local/',
            'shopware.plugin_directories.Community' => '/Applications/MAMP/htdocs/bootcamp/engine/Shopware/Plugins/Community/',
            'shopware.plugin_directories.ShopwarePlugins' => '/Applications/MAMP/htdocs/bootcamp/custom/plugins/',
            'shopware.plugin_directories.ProjectPlugins' => '/Applications/MAMP/htdocs/bootcamp/custom/project/',
            'shopware.template' => array(
                ...
                'charset' => 'utf-8',
                'forceCache' => false,
                'cacheDir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/templates',
                'compileDir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/templates',
                'templateDir' => '/Applications/MAMP/htdocs/bootcamp/themes/',
            ),
            ...
            'shopware.template.cacheDir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/templates',
            'shopware.template.compileDir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/templates',
            'shopware.template.templateDir' => '/Applications/MAMP/htdocs/bootcamp/themes/',
            'shopware.mail' => array(
                'charset' => 'utf-8',
            ),
            ...
            'shopware.httpcache' => array(
                ...
                'cache_dir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/html',
                'cache_cookies' => array(
                    0 => 'shop',
                    1 => 'currency',
            ...
            'shopware.httpcache.cache_dir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/html',
            ...
            'shopware.cache' => array(
                'frontendOptions' => array(
                    ...
                    'lifetime' => 3600,
                    'cache_id_prefix' => 'd30aaacb2171cde0be8fd13fbef0da99',
                ),
                'backend' => 'auto',
                'backendOptions' => array(
                    ...
                    'cache_dir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/general',
            ...
            'shopware.cache.frontendOptions.cache_id_prefix' => 'd30aaacb2171cde0be8fd13fbef0da99',
            ...
            'shopware.cache.backendOptions.cache_dir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/general',
            'shopware.cache.backendOptions.file_name_prefix' => 'shopware',
            'shopware.hook' => array(
                'proxyDir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/proxies',
                'proxyNamespace' => 'Shopware_Proxies',
            ),
            'shopware.hook.proxyDir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/proxies',
            'shopware.hook.proxyNamespace' => 'Shopware_Proxies',
            'shopware.model' => array(
                'autoGenerateProxyClasses' => false,
                'attributeDir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/doctrine/attributes',
                'proxyDir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/doctrine/proxies',
                'proxyNamespace' => 'Shopware\\Proxies',
                'cacheProvider' => 'auto',
                'cacheNamespace' => NULL,
            ),
            'shopware.model.autoGenerateProxyClasses' => false,
            'shopware.model.attributeDir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/doctrine/attributes',
            'shopware.model.proxyDir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/doctrine/proxies',
            ...
            'shopware.app' => array(
                'rootDir' => '/Applications/MAMP/htdocs/bootcamp/',
                'downloadsDir' => '/Applications/MAMP/htdocs/bootcamp/files/downloads/',
                'documentsDir' => '/Applications/MAMP/htdocs/bootcamp/files/documents/',
            ),
            'shopware.app.rootDir' => '/Applications/MAMP/htdocs/bootcamp/',
            'shopware.app.downloadsDir' => '/Applications/MAMP/htdocs/bootcamp/files/downloads/',
            'shopware.app.documentsDir' => '/Applications/MAMP/htdocs/bootcamp/files/documents/',
            'shopware.web' => array(
                'webDir' => '/Applications/MAMP/htdocs/bootcamp/web/',
                'cacheDir' => '/Applications/MAMP/htdocs/bootcamp/web/cache/',
            ),
            'shopware.web.webDir' => '/Applications/MAMP/htdocs/bootcamp/web/',
            'shopware.web.cacheDir' => '/Applications/MAMP/htdocs/bootcamp/web/cache/',
            'shopware.mpdf' => array(
                'defaultConfig' => array(
                    'tempDir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/mpdf/',
                    'fontDir' => '/Applications/MAMP/htdocs/bootcamp/engine/Library/Mpdf/ttfonts//',
                    'fonttrans' => array(
                        'helvetica' => 'arial',
                        'verdana' => 'arial',
                        'times' => 'timesnewroman',
            ...
            'shopware.mpdf.defaultConfig.tempDir' => '/Applications/MAMP/htdocs/bootcamp/var/cache/production_201902250948/mpdf/',
            'shopware.mpdf.defaultConfig.fontDir' => '/Applications/MAMP/htdocs/bootcamp/engine/Library/Mpdf/ttfonts//',
