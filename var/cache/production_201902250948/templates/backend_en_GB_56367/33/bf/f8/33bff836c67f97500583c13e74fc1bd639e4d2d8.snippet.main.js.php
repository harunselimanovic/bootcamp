<?php /* Smarty version Smarty-3.1.12, created on 2019-04-04 14:00:04
         compiled from "/Applications/MAMP/htdocs/bootcamp/themes/Backend/ExtJs/backend/product_stream/controller/main.js" */ ?>
<?php /*%%SmartyHeaderCode:20564823945ca5f1c41270b4-45001452%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '33bff836c67f97500583c13e74fc1bd639e4d2d8' => 
    array (
      0 => '/Applications/MAMP/htdocs/bootcamp/themes/Backend/ExtJs/backend/product_stream/controller/main.js',
      1 => 1551080958,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20564823945ca5f1c41270b4-45001452',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5ca5f1c41ab9b1_02878824',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ca5f1c41ab9b1_02878824')) {function content_5ca5f1c41ab9b1_02878824($_smarty_tpl) {?>/**
 * Shopware 5
                ...
                duplicatedRecord.save({
                    success: function (newRecord) {
                        if (newRecord.get('type') == 2) {
                            Ext.Ajax.request({
                                url: '<?php echo '/bootcamp/shopware.php/backend/ProductStream/copySelectedProducts';?>',
                                params: {
                        ...
                        Ext.Ajax.request({
                            url: '<?php echo '/bootcamp/shopware.php/backend/ProductStream/copyStreamAttributes';?>',
                            params: {
                                sourceStreamId: record.get('id'),
                                targetStreamId: newRecord.get('id')
                            }
