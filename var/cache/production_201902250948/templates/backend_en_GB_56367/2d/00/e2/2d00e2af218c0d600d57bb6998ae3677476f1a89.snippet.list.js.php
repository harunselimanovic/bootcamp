<?php /* Smarty version Smarty-3.1.12, created on 2019-04-04 14:00:10
         compiled from "/Applications/MAMP/htdocs/bootcamp/themes/Backend/ExtJs/backend/theme/controller/list.js" */ ?>
<?php /*%%SmartyHeaderCode:9270477835ca5f1ca19c296-51903184%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2d00e2af218c0d600d57bb6998ae3677476f1a89' => 
    array (
      0 => '/Applications/MAMP/htdocs/bootcamp/themes/Backend/ExtJs/backend/theme/controller/list.js',
      1 => 1551080958,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9270477835ca5f1ca19c296-51903184',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5ca5f1ca201ef8_81414928',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ca5f1ca201ef8_81414928')) {function content_5ca5f1ca201ef8_81414928($_smarty_tpl) {?>/**
 * Shopware 5
...
');
        ...
        Ext.Ajax.request({
            url: '<?php echo '/bootcamp/shopware.php/backend/theme/assign';?>',
            method: 'POST',
            params: {
                shopId: shop.get('id'),
...
',
    ...
    onPreviewTheme: function () {
        var me = this, shop, theme,
            url = '<?php echo '/bootcamp/shopware.php/backend/theme/preview';?>';
...
');
            ...
            Ext.Ajax.request({
                url: '<?php echo '/bootcamp/shopware.php/backend/theme/resetPreviewSession';?>',
                method: 'POST',
                params: {
                    shopId: shop.get('id')
                }
