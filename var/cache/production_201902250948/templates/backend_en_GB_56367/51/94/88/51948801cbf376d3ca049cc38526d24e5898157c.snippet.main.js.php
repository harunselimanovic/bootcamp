<?php /* Smarty version Smarty-3.1.12, created on 2019-04-04 14:00:02
         compiled from "/Applications/MAMP/htdocs/bootcamp/themes/Backend/ExtJs/backend/index/controller/main.js" */ ?>
<?php /*%%SmartyHeaderCode:11738080525ca5f1c20d6bd4-12936640%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '51948801cbf376d3ca049cc38526d24e5898157c' => 
    array (
      0 => '/Applications/MAMP/htdocs/bootcamp/themes/Backend/ExtJs/backend/index/controller/main.js',
      1 => 1551080958,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11738080525ca5f1c20d6bd4-12936640',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ca5f1c2205b88_08951850',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ca5f1c2205b88_08951850')) {function content_5ca5f1c2205b88_08951850($_smarty_tpl) {?>/**
 * Shopware 5
...
<?php $_tmp8=ob_get_clean();?><?php if ($_tmp8){?>*/
    ...
    checkLoginStatus: function () {
        Ext.TaskManager.start({
            ...
            run: function () {
                Ext.Ajax.request({
                    url: '<?php echo '/bootcamp/shopware.php/backend/login/getLoginStatus';?>',
                    success: function(response) {
                        var json = Ext.decode(response.responseText);

                        if(!json.success) {
                            window.location.href = '<?php echo '/bootcamp/shopware.php/backend';?>';
                        }
                    },
                    failure: function() {
                        window.location.href = '<?php echo '/bootcamp/shopware.php/backend';?>';
    ...
    checkBenchmarksStatus: function () {
        var interval = 10000,
            checkBenchmarksFn = function () {
                Ext.Ajax.request({
                    url: '<?php echo '/bootcamp/shopware.php/backend/benchmark/checkBenchmarks';?>',
                    success: function(response) {
