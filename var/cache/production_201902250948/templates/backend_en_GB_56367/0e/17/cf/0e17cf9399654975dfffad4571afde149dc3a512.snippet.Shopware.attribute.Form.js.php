<?php /* Smarty version Smarty-3.1.12, created on 2019-04-04 14:00:01
         compiled from "/Applications/MAMP/htdocs/bootcamp/themes/Backend/ExtJs/backend/base/attribute/Shopware.attribute.Form.js" */ ?>
<?php /*%%SmartyHeaderCode:211734195ca5f1c13bfd06-00299750%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0e17cf9399654975dfffad4571afde149dc3a512' => 
    array (
      0 => '/Applications/MAMP/htdocs/bootcamp/themes/Backend/ExtJs/backend/base/attribute/Shopware.attribute.Form.js',
      1 => 1551080958,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '211734195ca5f1c13bfd06-00299750',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5ca5f1c1428f64_13063852',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ca5f1c1428f64_13063852')) {function content_5ca5f1c1428f64_13063852($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.attribute.Form', {
    ...
    loadAttribute: function(foreignKey, callback) {
        ...
        me.load({
            url: '<?php echo '/bootcamp/shopware.php/backend/AttributeData/loadData';?>',
            params: {
    ...
    saveAttribute: function(foreignKey, callback) {
        ...
        me.submit({
            url: '<?php echo '/bootcamp/shopware.php/backend/AttributeData/saveData';?>',
            params: {
                _table: me.table,
                _foreignKey: foreignKey
            },
