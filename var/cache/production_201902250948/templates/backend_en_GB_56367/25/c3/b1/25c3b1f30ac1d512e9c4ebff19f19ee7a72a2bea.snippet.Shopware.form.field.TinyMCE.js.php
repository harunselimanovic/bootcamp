<?php /* Smarty version Smarty-3.1.12, created on 2019-04-04 14:00:00
         compiled from "/Applications/MAMP/htdocs/bootcamp/themes/Backend/ExtJs/backend/base/component/Shopware.form.field.TinyMCE.js" */ ?>
<?php /*%%SmartyHeaderCode:7584280085ca5f1c0543518-43302259%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '25c3b1f30ac1d512e9c4ebff19f19ee7a72a2bea' => 
    array (
      0 => '/Applications/MAMP/htdocs/bootcamp/themes/Backend/ExtJs/backend/base/component/Shopware.form.field.TinyMCE.js',
      1 => 1551080958,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7584280085ca5f1c0543518-43302259',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ca5f1c05a83e6_76418169',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ca5f1c05a83e6_76418169')) {function content_5ca5f1c05a83e6_76418169($_smarty_tpl) {?>/**
 * Shopware 5
...
",
            ...
            document_base_url: '<?php ob_start();?><?php echo 'http://localhost:8888/bootcamp/shopware.php/backend';?><?php $_tmp1=ob_get_clean();?><?php echo $_tmp1;?>
/'.replace('/backend', ''),
            
            // Content CSS - Styles the tiny mce editor. Please note the append timestamp. It's used to prevent caching the stylesheet
            contentCSS: 'http://localhost:8888/bootcamp/themes/Backend/ExtJs/backend/_resources/styles/tiny_mce.css?_dc=' + new Date().getTime(),
     ...
     */
    preloadImageUrl: '<?php echo '/bootcamp/shopware.php/backend/MediaManager/getMediaUrls';?>',
    ...
    replaceSmartyPluginWithImagePaths: function(rawContent) {
        ...
        Ext.each(images, function(img) {
            ...
            element.setAttribute('src', '/bootcamp/engine/Library/TinyMce/plugins/media_selection/assets/placeholder-image.png');
        });
