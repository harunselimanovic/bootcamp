<?php /* Smarty version Smarty-3.1.12, created on 2019-04-04 14:00:04
         compiled from "/Applications/MAMP/htdocs/bootcamp/themes/Backend/ExtJs/backend/customer/controller/stream.js" */ ?>
<?php /*%%SmartyHeaderCode:4720418145ca5f1c4d8da48-73830797%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '93805352f70f71614d5c5dfa0a95f3eae7f2a7d1' => 
    array (
      0 => '/Applications/MAMP/htdocs/bootcamp/themes/Backend/ExtJs/backend/customer/controller/stream.js',
      1 => 1551080958,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4720418145ca5f1c4d8da48-73830797',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5ca5f1c4eb1837_58421925',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ca5f1c4eb1837_58421925')) {function content_5ca5f1c4eb1837_58421925($_smarty_tpl) {?>/**
 * Shopware 5
...
', next.get('name'), total - streams.length, total),
    ...
    checkIndexState: function() {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/bootcamp/shopware.php/backend/CustomerStream/getNotIndexedCount';?>',
...
<?php $_tmp2=ob_get_clean();?><?php if (!$_tmp2){?>*/
    ...
    changeAutoIndex: function(checkbox, newValue) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/bootcamp/shopware.php/backend/UserConfig/save';?>',
            params: {
...
<?php $_tmp9=ob_get_clean();?><?php if (!$_tmp9){?>*/
        ...
        Ext.Ajax.request({
            url: '<?php echo '/bootcamp/shopware.php/backend/CustomerStream/loadStream';?>',
            params: {
            ...
            success: function(operation) {
                ...
                me.start(
                    [{
                        url: '<?php echo '/bootcamp/shopware.php/backend/CustomerStream/indexStream';?>',
                        params: {
...
<?php $_tmp10=ob_get_clean();?><?php if (!$_tmp10){?>*/
        ...
        me.getSearchIndexingParameters(force, function(params) {
            me.start(
                [{
                    url: '<?php echo '/bootcamp/shopware.php/backend/CustomerStream/buildSearchIndex';?>',
                    params: params
                }],
                callback
            );
    ...
    getSearchIndexingParameters: function(force, callback) {
        Ext.Ajax.request({
            ...
            success: function(operation) {
                ...
                Ext.Ajax.request({
                    url: '<?php echo '/bootcamp/shopware.php/backend/CustomerStream/getCustomerCount';?>',
                    params: {},
                    success: function (operation) {
    ...
    resetProgressbar: function () {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/bootcamp/shopware.php/backend/CustomerStream/getLastFullIndexTime';?>',
            success: function(operation) {
                var response = Ext.decode(operation.responseText);
                Ext.defer(function () {
