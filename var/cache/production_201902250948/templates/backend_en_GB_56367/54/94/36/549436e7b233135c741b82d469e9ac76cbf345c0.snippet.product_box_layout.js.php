<?php /* Smarty version Smarty-3.1.12, created on 2019-04-04 14:00:00
         compiled from "/Applications/MAMP/htdocs/bootcamp/themes/Backend/ExtJs/backend/base/store/product_box_layout.js" */ ?>
<?php /*%%SmartyHeaderCode:14944135795ca5f1c03ea140-06130343%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '549436e7b233135c741b82d469e9ac76cbf345c0' => 
    array (
      0 => '/Applications/MAMP/htdocs/bootcamp/themes/Backend/ExtJs/backend/base/store/product_box_layout.js',
      1 => 1551080958,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14944135795ca5f1c03ea140-06130343',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5ca5f1c04350a5_84689941',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ca5f1c04350a5_84689941')) {function content_5ca5f1c04350a5_84689941($_smarty_tpl) {?>/**
 * Shopware 5
    ...
    createLayoutData: function(config) {
        ...
        if (me.getConfigValue(config, 'displayExtendLayout')) {
            data.push({
                ...
                image: '/bootcamp/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_parent.png'
            });
        }
        if (me.getConfigValue(config, 'displayBasicLayout')) {
            data.push({
                ...
                image: '/bootcamp/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_basic.png'
            });
        }
        if (me.getConfigValue(config, 'displayMinimalLayout')) {
            data.push({
                ...
                image: '/bootcamp/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_minimal.png'
            });
        }
        if (me.getConfigValue(config, 'displayImageLayout')) {
            data.push({
                ...
                image: '/bootcamp/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_image.png'
            });
        }
        if (me.getConfigValue(config, 'displayListLayout')) {
            data.push({
                ...
                image: '/bootcamp/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_list.png'
            });
        }
